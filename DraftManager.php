...
require_once(DOKU_PLUGIN . 'wikiiocmodel/projects/default/DokuModelAdapter.php'); //CAL Canviar de ruta quan es WikiPagerSystemmanager passi al plugin de persistència
/**
 * Class DraftManager
 *
