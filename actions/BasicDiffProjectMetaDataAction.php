...
class BasicDiffProjectMetaDataAction extends ProjectMetadataAction {
    ...
    protected function runProcess() {
        ...
        if ($this->params['rev2']) {
            ...
            $revTrev = false;
            $aver = $this->projectModel->getActualRevision();
            ...
            $this->projectModel->setActualRevision($aver); //regenera al estado anterior la obtención de datos de la versión actual
