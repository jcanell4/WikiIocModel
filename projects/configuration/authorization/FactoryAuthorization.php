<?php
/**
 * FactoryAuthorization: carga las clases de autorización de los comandos del proyecto "configuration"
...
class FactoryAuthorization extends ProjectFactoryAuthorization {
    ...
    const PROJECT_AUTH = WIKI_IOC_MODEL . "projects/configuration/authorization/";
