...
class configurationDokuModelManager extends AbstractModelManager{
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \configuration\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\configuration");
