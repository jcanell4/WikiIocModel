...
/**
 * DokuModelManager:
 * - proporciona acceso a las Autorizaciones, ModelAdapter y Renderer del proyecto 'convocatoriesoficialseoi
...
class convocatoriesoficialseoiDokuModelManager extends AbstractModelManager{
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \convocatoriesoficialseoi\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\convocatoriesoficialseoi");
