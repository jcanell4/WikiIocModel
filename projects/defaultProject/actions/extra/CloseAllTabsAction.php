 ...
 */
abstract class CloseAllTabsAction extends DokuAction {
    ...
    protected function startProcess(){        
        global $ID, $ACT, $REV, $RANGE, $DATE, $PRE, $TEXT, $SUF, $SUM;
        ...
        if ( $this->params[PageKeys::KEY_PRE] ) {
            $PRE = $this->params[PageKeys::KEY_PRE] = cleanText( substr( $this->params[PageKeys::KEY_PRE], 0, - 1 ) );
        }
        if ( $this->params['text'] ) {
