<?php
/**
 * FactoryAuthorization: carga las clases de autorización de los comandos del proyecto "iocdocum"
...
class FactoryAuthorization extends AbstractFactoryAuthorization {
    ...
    const PROJECT_AUTH = WIKI_IOC_MODEL . "projects/iocdocum/authorization/";
