...
class ProjectModel extends AbstractProjectModel {
    ...
    public function generateProject($id, $projectType) {
        ...
        $destino = $ret['projectMetaData']["fitxercontinguts"]['value'];
        ...
        //1.2 Crea un proyecto de tipo taulasubs dentro de este proyecto
        $this->createProjectTaulaSubs($destino, $plantilla, NULL, "generate project");
