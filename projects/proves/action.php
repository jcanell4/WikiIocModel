...
class action_plugin_wikiiocmodel_projects_proves extends WikiIocPluginAction {
    private $viewArray;
    ...
    function addCommands(Doku_Event &$event, $param) {
        $event->data["projectrender"] = array(
            "callFile" => WIKI_IOC_MODEL."projects/proves/command/projectrender_command.php"
        );
    }
    ...
    function addControlScripts(Doku_Event &$event, $param) {
        ...
        $path = WIKI_IOC_MODEL."projects/proves/metadata/config/";
