require([
        ...
        var ptfploePdfExportButton = registry.byId('ptfploePdfExport');
        ...
        if (ptfploePdfExportButton){
            ptfploePdfExportButton.getQuery=fGetQuery;
            ptfploePdfExportButton.set("hasTimer", true);
            ptfploePdfExportButton.onClick =fOnClick;
        }
});
