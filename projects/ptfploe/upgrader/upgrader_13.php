<?php
/**
 * upgrader_13: Transforma el archivo continguts.txt del proyecto "ptfploe" desde la versión 11 a la versión 12
        ...
        switch ($type) {
            ...
            case "templates":
                ...
                */
                ...
                if (!empty($doc)) {
                    $this->model->setRawProjectDocument($filename, $doc, "Upgrade: version 12 to 13");
                }
                $status = !empty($doc);
        }
        return $status;
