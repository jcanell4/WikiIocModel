<?php
/**
 * upgrader_19: Transforma el archivo continguts.txt del proyecto "ptfploe" desde la versión 11 a la versión 12
        ...
        switch ($type) {
            ...
            case "templates":
                ...
                */
                ...
                if (!empty($doc)) {
                    $this->model->setRawProjectDocument($filename, $doc, "Upgrade: version 18 to 19");
                }
                $status = !empty($doc);
        }
        return $status;
