...
/**
 * DokuModelManager:
 * - proporciona acceso a las Autorizaciones, ModelAdapter y Renderer del proyecto 'ptfploe24'
...
class ptfploe24DokuModelManager extends AbstractModelManager{
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \ptfploe24\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\ptfploe24");
