...
/**
 * DokuModelManager:
 * - proporciona acceso a las Autorizaciones, ModelAdapter y Renderer del proyecto 'ptfploeNou'
...
class ptfploeNouDokuModelManager extends AbstractModelManager{
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \ptfploeNou\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\ptfploeNou");
