...
<span class="hamburger hidden" id="myHamburger" onclick="openNav()"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30" height="30" focusable="false"><title>Menu</title><path stroke="currentColor" stroke-width="2.4" stroke-linecap="butt" stroke-miterlimit="10" d="M4 7h22M4 15h22M4 23h22"></path></svg></span>
  ...
  <header class="main_header">
    <div class="container">
      ...
      <h2>{##creditId##} {##credit##}<WIOCCL:IF condition="''cr&egrave;dit''!={##tipusBlocCredit##}">-{##tipusBlocCredit##}</WIOCCL:IF></h2>
    </div>
  </header>
  ...
  <section id="intro">
    <div class="container">
      <p><span>Durada del <WIOCCL:IF condition="''cr&egrave;dit''!={##tipusBlocCredit##}">bloc</WIOCCL:IF><WIOCCL:IF condition="''cr&egrave;dit''=={##tipusBlocCredit##}">cr&egrave;dit</WIOCCL:IF></span>: {##durada##} hores</p>
