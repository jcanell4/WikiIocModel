...
/**
 * DokuModelManager:
 * - proporciona acceso a las Autorizaciones, ModelAdapter y Renderer del proyecto 'ptfplogse'
...
class ptfplogseDokuModelManager extends AbstractModelManager{
    ...
    static $defMainClass = array(
               ...
               'Permission'           => self::DLI."authorization/SupervisorPermission.php"
           );
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \ptfplogse\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\ptfplogse");
