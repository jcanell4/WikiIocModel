<?php
/**
 * upgrader_30: Transforma el archivo continguts.txt de los proyectos 'ptfploe'
...
class upgrader_30 extends ProgramacionsCommonUpgrader {
    ...
    public function process($type, $ver, $filename=NULL) {
        switch ($type) {
            ...
            case "templates":
                ...
                $aTokRep = [["^(  :title:Blocs\n.*\n<WIOCCL:FOR.*{#_COUNTDISTINCT\({##taulaDadesUD##}.*\n(.*\s)<WIOCCL:FOREACH var=\"item\" array=\"{##sortedTaulaDadesUD##}\")(>)$",
