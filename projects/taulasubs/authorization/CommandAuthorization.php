<?php
/**
 * CommandAuthorization: define la clase de autorizaciones de los comandos del proyecto "taulasubs"
...
require_once(WIKI_IOC_PROJECTS."taulasubs/authorization/Permission.php");
