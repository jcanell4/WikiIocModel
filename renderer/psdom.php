...
abstract class AbstractNodeDoc{
    ...
    public function __construct($type, LeveledNodeDoc &$parent=NULL) {
        $this->father = &$parent;
        if($parent!=NULL){
...
//     */
//    public function init($params) {
//        $this->pdfBuilder = new IocTcPdf(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
//    }
//
//    /**
//     * Returns the format produced by this renderer.
...
//     */
//    private function _initialize_globals(){
//    }
//
...
//
//    function render_TOC() {
//        $this->pdfBuilder->addTOCPage();
//        $this->pdfBuilder->addTOC(1, 'courier', '.', 'B');
//        return '';
//    }
//
////    function toc_additem($id, $text, $level) {
...
//            $text = preg_replace('/\n/', '<br>', $text);
//        }
//        $this->pdfBuilder->writeHTML($text);
//    }
//
////    function p_open() {}
//
...
//
//    function header($text, $level, $pos){
//        $this->pdfBuilder->Bookmark($text, $level-1);
//        $this->pdfBuilder->Cell(0, 0, $text );
//        
//        
////        global $conf;
////
